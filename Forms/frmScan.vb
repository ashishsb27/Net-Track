...
Public Class frmScan
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        If Not ProgressBar1.Value = ProgressBar1.Maximum Then
            ...
            Try
                ...
                Dim read As String = My.Computer.FileSystem.ReadAllText("unpacked_hashes.md5.txt").ToString
        ...
        Else
            ...
            If ListBox2.Items.Count > 0 Then
                MessageBox.Show("Scanning Has Been Completed. There was " & vbCrLf & ListBox2.Items.Count & "Virusus decteted, Please review the list and choose an action.", CStr(MessageBoxButtons.OK))
    ...
    Private Sub MyButton1_Click(sender As Object, e As EventArgs) Handles MyButton1.Click
        If MessageBox.Show("Are you sure you want to abort the scan?", "Confirmation", MessageBoxButtons.YesNo) <> DialogResult.Yes Then
            Timer1.Stop()
            If ListBox2.Items.Count > 0 Then
                MsgBox("Scanning has been completed. There was " & vbCrLf & ListBox2.Items.Count & "Virusus decteted, Please review the list and choose an action.", CStr(MessageBoxButtons.OK))
                Timer1.Stop()
                ProgressBar1.Value = 0
                MyButton1.Enabled = False
                MyButton3.Enabled = True
    ...
    Private Sub headerPanel2_MouseDown(sender As Object, e As MouseEventArgs) Handles headerPanel2.MouseDown
    ...
    Private Sub MyButton3_Click(sender As Object, e As EventArgs) Handles MyButton3.Click
        ...
        While ListBox2.Items.Count - 1 = ListBox1.SelectedIndex = False
            ListBox2.SelectedIndex += 1
            File.Delete(CStr(ListBox2.SelectedIndex))
            If ListBox2.Items.Count = ListBox2.SelectedIndex + 1 Then
                ListBox2.Items.Clear()
                ListBox2.Enabled = True
                MessageBox.Show("All Virusus ahve been removed. Your coputer is now secured. ", CStr(MessageBoxButtons.OK))
                ProgressBar1.Value = 0
                MyButton1.Enabled = False
